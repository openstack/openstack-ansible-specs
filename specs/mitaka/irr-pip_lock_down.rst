...
###################
:date: 2015-11-01
:tags: independent-role-repositories, pip_lock_down

Split out the pip_lock_down role into it's own repository.
...
"pip_lock_down" need to be moved from the monolithic stack and
