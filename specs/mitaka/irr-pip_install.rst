...
#################
:date: 2015-11-01
:tags: independent-role-repositories, pip_install

Split out the pip install role into it's own repository.
...
"pip_install" need to be moved from the monolithic stack and
