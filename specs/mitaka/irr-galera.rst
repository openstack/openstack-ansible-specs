...
############
:date: 2015-11-01
:tags: independent-role-repositories, galera

Split out the galera_server and galera_client roles into it's own repository.
...
"galera_server" and "galera_client" need to be moved from the monolithic stack
and into the it's own role repository.
