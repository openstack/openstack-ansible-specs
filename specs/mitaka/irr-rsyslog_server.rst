...
####################
:date: 2015-11-01
:tags: independent-role-repositories, rsyslog_server

Split out the rsyslog_server role into it's own repository.
...
"rsyslog_server" need to be moved from the monolithic stack and
