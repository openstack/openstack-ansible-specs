...
##############
:date: 2015-11-01
:tags: independent-role-repositories, lxc_host

Split out the lxc host role into it's own repository.
...
"lxc_host" need to be moved from the monolithic stack and
